...
<table width="100%" height="17%" border="1" align="center">
    <tr>
      ...
      <th width="176" scope="col">Approve</th>
	   ...
	   <th width="110" scope="col">View</th>
    </tr>
	<%
		session.setAttribute("rejected1","rejected1");
   		Connection con1=DBInfo.con;
		String query1="select * from article where rejected='1'";
		...
		<tr>
		  ...
		  <td scope="col"><%=s5%></td>
		  <td scope="col"><div align="center"><a href=../moderator/ApprovalDone.jsp?AId=<%=s2%>>Approve</a></div></td>
		  <td scope="col"><div align="center"><a href=../user/UDeletionDone.jsp?ArticleId=<%=s2%>>Delete</a></div></td>
		  <td scope="col"><div align="center"><a href=CommonToAll.jsp?AID=<%=s2%>&amp;mod>View Post</a></div></td>
    	</tr>
		<%
		}
		if(flag==0)

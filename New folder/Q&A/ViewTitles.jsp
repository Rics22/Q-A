...
<body>
	  ...
	  <%
			...
			String query="select subject,articleid,sub_date from article where approved ='1' order by sub_date desc limit 10";
...
%>
	...
	<form action="user/Comment.jsp" method="post">
	  <table width="100%" height="100%" border="1" cellpadding="10">
		 <tr>
          <td height="37" colspan="4"><%=subject%><a href=Index.jsp?AID=<%=articleid%>>View</a></td>
        </tr>    
      </table>

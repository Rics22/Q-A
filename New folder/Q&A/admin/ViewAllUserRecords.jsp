...
<div class="w3-row-padding">
  ...
  <table class="table1" width="100%" height="69" border="1" align="center">
    <tr>
	...
	<%
		...
		<tr>
		  ...
		  <td scope="col"><div align="center"><a href=DeletionDone.jsp?email=<%=s4%> class="w3-button w3-round-large w3-red" onclick="return confirm('Are you sure you want to delete?')">Delete</a></div></td>
    	</tr>
		<%
		}
		if(flag==0)

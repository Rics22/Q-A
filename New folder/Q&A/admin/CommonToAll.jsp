...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href=CommonToAll.jsp?Admin class="w3-bar-item w3-button w3-padding-large w3-theme-d4"><i class="fa fa-home w3-margin-right"></i>Q&A</a>
  ...
  <a href=CommonToAll.jsp?sendmail class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="Send Mail"><i class="fa fa-envelope"></i></a>

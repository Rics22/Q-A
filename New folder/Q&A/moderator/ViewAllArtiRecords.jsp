...
<table class= "table1" width="100%" height="17%" border="1" align="center">
    <tr>
	...
	<%
		...
		<tr>
		  ...
		  {
		  %>
		  <td scope="col"><div align="center"><a href=../moderator/ApprovalDone.jsp?AId=<%=s2%> class="w3-button w3-round-large w3-green">Approve</a> <a href=RejectionDone.jsp?AId=<%=s2%> class="w3-button w3-round-large w3-red">Reject</a></div></td>
		  <td scope="col"><div align="center"><a href=../user/UDeletionDone.jsp?ArticleId=<%=s2%> class="w3-button w3-theme" onclick="return confirm('Are you sure you want to delete?')">Delete</a></div></td>
		   <%
		   }
		  if((String)session.getAttribute("utype1")=="Admin")
		  {
		  %>
		   <td scope="col"><div align="center"><a href=ApprovalDone.jsp?AId=<%=s2%> class="w3-button w3-round-large w3-green">Approve</a> <a href=RejectionDone.jsp?AId=<%=s2%> class="w3-button w3-round-large w3-red">Reject</a></div></td>
		  <td scope="col"><div align="center"><a href=../user/UDeletionDone.jsp?ArticleId=<%=s2%> class="w3-button w3-theme" onclick="return confirm('Are you sure you want to delete?')">Delete</a></div></td>
		  <%
		  }
		  %>

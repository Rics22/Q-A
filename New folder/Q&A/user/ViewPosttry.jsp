...
<%
			...
			%>
							<tr>
							  <td height="23" colspan="4">
								<div align="center">
								<a href=CommonToAll.jsp?ArticleIdUpdt=<%=articleid%> class="w3-button w3-round-large w3-green">Update Post</a>
								&nbsp;&nbsp;<a href=CommonToAll.jsp?ArticleIdDlt=<%=articleid%> class="w3-button w3-round-large w3-red">Delete Post</a>								</div>							 							  </td>
							</tr>
		...
		<tr>
				...
				<div align="center"><a href=QLike.jsp?ArtiId=<%=articleid%> class="w3-button w3-theme"><i class="fa fa-thumbs-up"></i> Like <%=like%> </a>
				&nbsp;&nbsp;<a href=QDisLike.jsp?ArtiId=<%=articleid%> class="w3-button w3-theme"><i class="fa fa-thumbs-down"></i> Dislike <%=dislike%></a></div></td>	
				  <%
				  }
				  else
				  {

...
%>
	...
	<div class="w3-container w3-content" style="max-width:1000px;margin-top:5px"> 
<div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding" >
	  <table class= "table1" width="100%" border="1" cellpadding="10">
        <tr>
        ...
        <tr>
          <td width="20%" ><span class="style1">Answer:</span> </td>
          <td width="80%"><textarea name="textarea2" cols="80%" rows="8" readonly="readonly"> <%=article%></textarea></td>
        </tr>
<%
		...
		%>
				    <td colspan="4"><div align="center"><a href=CommonToAll.jsp?ViewPostId=<%=articleid%> class="w3-button w3-round-large w3-green">View</a></div></td>
        </tr>	
...
%>
		...
		if(k==0)
		{
			...
			%>
	  			 ...
	  			 <p align="center">
	  		 	 <a href="CommonToAll.jsp?pgid=<%=k+1%>&ViewAllPost" class="w3-button w3-theme">Next</a></p>
	 			 <p>
		...
		else
		{
			...
			{
		%>
				 <p align="center"><a href="CommonToAll.jsp?pgid=<%=(k-3)%>&ViewAllPost" class="w3-button w3-theme">Previous</a>
				 <%
				 if(k<pagecount)
				 {
				 %>

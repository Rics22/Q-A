...
<table class="table1" width="80%" border="1" border-collapse="true" cellpadding="10">
        <tr>
        ...
        <tr>
          ...
          <td width="74%"><textarea name="textarea3"  class="w3-border w3-padding" cols="80%" readonly="readonly" cols="100%" rows="8"><%=article%></textarea></td>
        </tr>
			
		  <tr>
          <td colspan="4"><div align="center"><a href=CommonToAll.jsp?ViewPostId=<%=articleid%> class="w3-button w3-theme">View</a></div></td>
        </tr>
	  ...
	  <p>
	    ...
	    <%
			if(k==0)
			{
				...
				{
				%>
<p align="center"><a href="CommonToAll.jsp?pgid=<%=k+1%>&ViewSelfPost" class="w3-button w3-theme">Next</a></p>
				<%
				}
			//------------------
			}
			...
			%>
					...
					<p align="center"><a href="CommonToAll.jsp?pgid=<%=k-3%>&ViewSelfPost" class="w3-button w3-theme">Previous</a>
	    			<%
						 if(k<pagecount)
						 {
						 %>
						&nbsp;<a href="CommonToAll.jsp?pgid=<%=k+1%>&ViewSelfPost" class="w3-button w3-theme">Next</a></p>
						 <%
						 }
					%> <%
			 	}

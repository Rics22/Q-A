...
<%
							...
							String qdislk1=(String)session.getAttribute("qdislk");
							String aid2=(String)session.getAttribute("ArtiId");
							System.out.println(aid2+":::::::::::::::::::::::::::"+qdislk1);
							Connection con2= DBInfo.con;
							String query2="update article set QDisLike=? where articleid=?";
							PreparedStatement ps2=con2.prepareStatement(query2);
							ps2.setString(1,qdislk1);

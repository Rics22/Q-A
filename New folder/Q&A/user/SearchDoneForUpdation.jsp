        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding" >
				<h6 class="w3-opacity">Update Post</h6>
...
<br />
    <textarea name="textarea" class="w3-border w3-padding" cols="100%" rows="8"><%=article%></textarea>
    
  <br />
      <div align="center">
        <input type="submit" class="w3-button w3-theme" value="Update" />
      </div>    
  </div>
          </div>
        </div>
